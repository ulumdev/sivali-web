...
/**
 * Detail page for Blocked employee.
 * Shows Reactivate action (unblock/activate).
 */
export default function EmployeeDetailBlocked(): React.JSX.Element {
  const { id } = useParams();
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-red-50 border border-red-100 text-red-700 rounded-md p-4">
        Akun telah diblokir — pengguna tidak dapat melakukan aktivitas secara permanen.
      </div>
