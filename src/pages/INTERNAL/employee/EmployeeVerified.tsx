...
import { useVerifiedEmployee } from "@/hooks/internal/useEmployeeInternal";
import { useNavigate } from "react-router-dom";

export default function EmployeeVerified() {
  const navigate = useNavigate();
  const { employees, loading, error } = useVerifiedEmployee();
